...
export default function Footer(props) {
  ...
  useEffect(() => {
    ...
    createLine(2, 5, 6, 5.2, "4563463", "4563463");
    createLine(2, 7, 6, 7.2, "4563463", "4563463");
    createLine(2, 9, 6, 9.2, "4563463", "4563463");
    createLine(2, 5, 6, 5.2, "4563463", "4563463");
    createLine(3, 3, 2.8, 8, "352352", "352352");
    createLine(5, 4, 4.8, 10, "745353", "745353");
    ...
    function handleLineClick(line, lineText) {
      if (line.classed("active")) {
        ...
        line.classed("active", true);
        d3.select(".ScreenItemInterpretation").html(
          `<div class="IntRaz">${lineText}</div>`
        );
      }
